...
import { View, Text, FlatList, TouchableOpacity, SectionList, SafeAreaView, Dimensions } from 'react-native';
...
const Tab1: React.FC<Props> = props => {
    ...
    useEffect(() => {
        if (shifts != null) {
            const filteredData = shifts.filter((item) => item.area === 'Helsinki' || item.area === 'Helsinki');
